...
# 实验结果保存路径（专属YOLOv5s）
RESULT_ROOT = r"/workspace/examples/PythonProject1/pest_experiment_results_yolov5s_optimizedx"
# 随机种子
SEED = 42
# 设备配置
...
# ====================== YOLOv5s 专属优化超参数 ======================
TRAIN_EPOCHS = 80      # YOLOv5s需要更多训练轮数充分收敛
